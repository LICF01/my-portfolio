...
export const ui = {
  ...
  es: {
    ...
    "about.content": [
      ...
      "Después de varios años con el violoncello y aprovechando la pandemía, decidí empezar algo nuevo y me enfoqué en el desarrollo de software 💻, desde entonces llevo aproximadamente 4 años programando 🕒 y actualmente me centro en el desarrollo front-end, utilizando React, Next.js y Astro 🚀, además estoy avanzando lenta pero constantemente en la universidad para obtener el título de Ingeniería en Informática 🎓, donde hasta ahora pude tener contacto con lenguajes como C y Java y trabajar en equipo remotamente con muy buenos compañeros.",
      "A parte de programar, mis intereses incluyen el diseño de interfaces de usuario 🎨, Linux 🐧, teclados ⌨️ jaja y disfruto de la lectura, especialmente libros  de ciencia ficción y thrillers. También podcasts normalmente, en inglés, y, por supuesto, de escuchar música.",
