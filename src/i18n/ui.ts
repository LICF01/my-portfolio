...
export const ui = {
  en: {
    ...
    "about.content": [
      ...
      "After several years with the cello and taking advantage of the pandemic, I decided to start something new and focused on software development 💻. Since then, I have been programming for approximately 4 years 🕒 and currently, I am focusing on front-end development, using React, Next.js, and Astro 🚀, alongside with CSS frameworks and tools like SASS, TailwindCSS and Styled Components also component libraries like MUI, for testing I've worked with Playwright, Puppeteer and Storybook and want to start with mobile development with React Native. I am also progressing step by step at the university looking to obtain a degree in Computer Engineering 🎓, where so far I have been able to work with languages like C and Java and work remotely in a team with very good colleagues",
  ...
  es: {
    ...
    "about.content": [
      "Soy un desarrollador radicado en Asunción, Paraguay, autodidacta y entusiasta de la tecnología. Antes de programar, aprendí a tocar el violonchelo 🎻 y tuve la oportunidad de tocar en varias orquestas en mi país, incluso de forma estable en algunas junto a excelentes instrumentistas",
      "Después de varios años con el violoncello y aprovechando la pandemía, decidí empezar algo nuevo y me enfoqué en el desarrollo de software 💻, desde entonces llevo aproximadamente 4 años programando 🕒 y actualmente me centro en el desarrollo front-end, utilizando React, Next.js y Astro 🚀, junto con frameworks y herramientas de CSS como SASS, TailwindCSS y Styled Components, sumado a experiencia con bibliotecas de componentes como MUI. Para pruebas, he trabajado con Playwright, Puppeteer y Storybook. A parte estoy buscando empezar con el desarrollo de aplicaciones moviles con React Native y avanzando paso a paso en la universidad buscando obtener el título de Ingeniería en Informática 🎓, donde pude tener contacto con lenguajes como C y Java y la experiencia inicial de haber hecho proyectos en equipo remotamente con muy buenos compañeros",
